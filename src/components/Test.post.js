          ...
          <form onSubmit={e => undleSubmit(e)} className="App-post">
              ...
              <div className="App-loading-form">
                  ...
                  <div>
                      ...
                      <br></br>
                      <textarea className="input-form-comment" placeholder="Inscrivez votre texte" width="200" maxLength="250" type="text" id="comment" name="comment" value={content} onChange={e => setContent(e.target.value)}/>
                  </div>
                  <div>
                      <label htmlFor="image">Image : </label>
                      <br></br>
                      <input className="input-form" type="file" id="image" name="image" onChange={e => setImageUrl(e.target.files[0])}/>
                  </div>
              </div>
